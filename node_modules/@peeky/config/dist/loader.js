...
export async function setupConfigLoader(options = {}) {
    async function loadConfig(loadFromVite = true) {
        ...
        try {
            ...
            if (file) {
                ...
                await eval(`import('${fixWindowsAbsoluteFileUrl(resolvedPath)}')`)).default;
