...
export function createConsoleFancyReporter() {
    return {
        ...
        summary: ({ fileCount, duration, suiteCount, errorSuiteCount, testCount, errorTestCount, snapshotCount, failedSnapshotCount, updatedSnapshotCount, newSnapshotCount, }) => {
