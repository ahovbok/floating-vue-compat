...
export async function runAllTests(config, options = {}) {
    ...
    const { suites, suiteCount, errorSuiteCount, testCount, errorTestCount, snapshotCount, failedSnapshots, newSnapshots, } = stats;
    // Error summary
    if (errorTestCount) {
