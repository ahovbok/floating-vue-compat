...
import { mergeConfig } from '@peeky/config';
...
export async function runTestFile(options) {
    try {
        ...
        const runtimeEnv = new RuntimeEnv(typeof runtimeEnvOption === 'string' ? runtimeEnvOption : runtimeEnvOption.envName, config, {
        ...
        const { failedSnapshots, newSnapshots, passedSnapshots, } = await snapshotMatcher.end(options.updateSnapshots);
