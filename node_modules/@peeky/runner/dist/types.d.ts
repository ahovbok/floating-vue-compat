...
export declare type TestFlag = 'only' | 'skip' | 'todo' | null;
...
export declare type TestSuiteChild = ['suite', TestSuite] | ['test', Test];
export declare type DescribeFn = ((title: string, handler: () => Awaitable<void>) => void) & {
...
export declare type TestFn = ((title: string, handler: () => Awaitable<void>) => void) & {
    skip: (title: string, handler: () => Awaitable<void>) => void;
    only: (title: string, handler: () => Awaitable<void>) => void;
    todo: (title: string, handler?: () => Awaitable<void>) => void;
};
export declare type BeforeAllFn = (handler: () => Awaitable<void>) => void;
export declare type AfterAllFn = (handler: () => Awaitable<void>) => void;
export declare type BeforeEachFn = (handler: () => Awaitable<void>) => void;
export declare type AfterEachFn = (handler: () => Awaitable<void>) => void;
export declare type ReporterSuiteChild = ['suite', ReporterTestSuite] | ['test', ReporterTest];
...
declare type TestSuiteInfoPayload = {
    suite: ReporterTestSuite;
};
declare type TestInfoPayload = TestSuiteInfoPayload & {
    test: ReporterTest;
};
declare type OptionalTestInfoPayload = {
    suite: ReporterTestSuite | null;
    test: ReporterTest | null;
};
...
export interface Reporter {
    log?: (payload: OptionalTestInfoPayload & {
        type: 'stdout' | 'stderr';
        text: string;
        file?: string;
    }) => unknown;
